...
const ROUTE = "GET /api/account/export";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const payload = {
      ...
      note: "Bu dosya yalnızca anonim yazma ritmi metriklerini içerir. Yazdığınız hiçbir karakter, kelime veya metin burada YOKTUR.",
    };
    ...
    logger.error("account export endpoint error", err, {
      requestId,
      route: ROUTE,
    });
